  ...
  const pipelineSteps = [
    {
      ...
      color: "text-blue-700 border-quantum/50"
    },
    {
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <Card className="bg-gradient-to-br from-card to-background-secondary border-quantum/30">
            <CardContent className="p-6 text-center">
              <Network className="h-8 w-8 text-blue-700 mx-auto mb-2" />
        ...
        >
          <Card className="bg-gradient-to-r from-quantum/10 to-neural/10 border-quantum/30">
            <CardContent className="p-6">
              <h3 className="font-semibold text-blue-700 mb-4">Key Achievements</h3>
        ...
        >
          ...
          <Button
            ...
            className="bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-3 shadow-lg border-2 border-green-800"
          >
