...
const FraudDecision: React.FC<FraudDecisionProps> = ({ onNext }) => {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-5xl space-y-8">
        ...
        {status === 'pending' ? (
          ...
          >
            <Button size="lg" onClick={() => onNext('landing')} className="bg-secondary text-secondary-foreground hover:bg-secondary/90">
